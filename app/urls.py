...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(next_page='home'), name='logout'),path('login/', auth_views.LoginView.as_view(template_name='app/pages/login.html'), name='login'),
